                    ...
                    <ul class="navbar-nav links nav-menu ml-auto">
                        ...
                        @else
                            <li class="nav-item links dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre><i class="fas fa-user-check"></i>
        ...
        <footer id="footer" class="navbar navbar-expand-lg nav-color py-5 mb-4">
            <div class="container justify-content-center flex-column">
                ...
                <div class="text-white pt-1">
                    <p>Made with <i class="far fa-heart mx-1"></i> by Travis Windsor-Cummings</p>
                </div>
            </div>
        </footer>
